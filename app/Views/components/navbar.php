<!-- components: navbar -->
<nav class="navbar" role="navigation" aria-label="main navigation" x-data="{ open: false, userMenu: false }">
  ...
  <div id="navbarBasicExample" class="navbar-menu" :class="{ 'is-active': open }"
    ...
    <div class="navbar-end" style="align-items: center;">
      <!-- Sleek Searchbar -->
      <div class="navbar-item" style="padding-left:1.5em;">
        <form class="field has-addons" style="width:220px;">
          <div class="control has-icons-left is-expanded" style="width:100%;">
            <input class="input" type="search" placeholder="Search..." style="width:100%; border-radius:0; box-shadow:none; border:1px solid #ddd; background:#fafbfc;">
            <span class="icon is-left">
              <i class="fas fa-search"></i>
            </span>
          </div>
          <div class="control">
            <button class="button is-primary" type="submit" style="border-radius:0;">
      ...
      <div class="navbar-item has-dropdown is-hoverable" @mouseenter="userMenu = true" @mouseleave="userMenu = false" @click.away="userMenu = false">
        <a class="navbar-link" @click.prevent="userMenu = !userMenu" style="display: flex; align-items: center; gap: 0.5em;">
          <span class="icon is-medium">
            <img src="<?= isset($profile_img) && $profile_img ? $profile_img : 'https://placehold.co/128' ?>" alt="User" style="border-radius:60%; width:2.2em; height:2.2em; object-fit:cover; border:2px solid #eee; background:#fff;">
          </span>
          <span class="is-hidden-mobile">Account</span>
        </a>
        <div class="navbar-dropdown is-right" x-show="userMenu" x-transition>
